...
def run_swiglu(
    ...
    # Problem 3.4.2: SwiGLU test adapter
...
def run_rmsnorm(
    ...
    """
    # Problem 3.4.1: RMSNorm test adapter
...
def get_tokenizer(
    ...
    """
    # 测试只通过 adapter 寻找学生实现；真正的 tokenizer 放在课程包中。
    ...
    **kwargs,
    ...
    Args:
        ...
        special_tokens (list[str]): A list of string special tokens to be added to the tokenizer vocabulary.
            ...
            kept as a single token. During BPE training, occurrences in `input_path`
            form hard boundaries and are excluded from merge statistics.
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    # 课程测试统一通过 adapters.py 调用学生实现。
    # 真正的算法放在 cs336_basics/bpe.py，避免把长代码堆在适配器中。
